...
<body>
    ...
    <section id="home">
        <div class="container-fluid">
            <h2 class="text-center">TRANSPORT BOOKINGS</h2>
...
$result = mysql_query("Select * from tb_trans  ");
    ...
    ?>
                    <tbody style="background-color:goldenrod; text-align:center;">
                        <tr>
                            ...
                            <td>
                            <a class="btn btn-success" style='text-decoration:none' <?php echo "<a  href=process.php?id=$row[id]>";?><b>Accept</b></a>
                   <hr>
                   <a class="btn btn-danger" style='text-decoration:none' <?php echo "<a  href=process11.php?id=$row[id]>";?><b>Cancel</b></a>
                    </td>
                            </td>
