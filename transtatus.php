...
$result = mysql_query("Select * from tb_trans where uname='$uname'");
    ...
    ?>
                    <tbody style="background-color:goldenrod; text-align:center;">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-danger" style='text-decoration:none' href='cancel.php' onclick="return confirm('Are you sure ? Do You Want Cancel Your Booking')" >Cancel Booking</a>
                            </td>
                        </tr>
                        </tbody>
                        <?php
